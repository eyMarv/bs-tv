...
def split_chlist_selected(
    thread_temppath, chlist_selected, splitname, download_threads, enable_multithread
):
    ...
    try:
        ...
        for i in ran:
            ...
            if i in steps or i == items - 1:
                part = os.path.join(
                    thread_temppath, "{}_{}.json".format(splitname, str(count))
                )
